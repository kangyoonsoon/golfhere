...
<section>
	...
	<div class="row layout">
		...
		<div class="col-8">
			<!-- register -->
			<h2 class="text-center my-5">골프장 후기 게시판 수정</h2>
			<form name="f"
				  method="post" 
				  action="board_edit_process.do" 
				  onsubmit="return check()"
				  enctype="multipart/form-data"
				  >
			
				<input type="hidden" name="page" value="${page}">  
				<input type="hidden" name="boardNumber" value="${board.board_num}">  
				...
				<div class="d-flex justify-content-center">
					<table class="w-75 table">
						<tr class="d-flex">
							...
							<td class="col-sm-10">
								<input
								class="form-control" type="text" id="board_title" name="board_title" value="${board.board_title}"></td>
						</tr>
						<tr class="d-flex">
							<th
								class="col-sm-2 text-left align-middle">골프장</th>
							<td class="col-md-4">
								<input type="text" id="board_coursename" class="form-control" name="board_coursename" value="${board.board_coursename}" >
							</td>
							<td class="col-sm-6">
						...
						<tr class="d-flex">
							...
							<td class="col-sm-10">
								<textarea class="form-control" id="board_content" name="board_content" rows="10">${board.board_content}</textarea>
							</td>	
						</tr>
						<tr class="d-flex">
							<th scope="row"
							...
							<td class="col-sm-10">
                                <div class="slidecontainer w-50">
                                    <p>바를 움직여 점수를 주세요.</p>
                                    <input type="range" min="0" max="100" value="${board.board_evaluation}" class="slider" id="myRange" name="board_evaluation">
					    ...
					    <tr class="d-flex">
							<th
								class="col-sm-2 text-left align-middle">비밀번호</th>
							<td class="col-sm-10">
								<input
								class="form-control" type="password" id="board_pwd" name="pwd"></td>
						</tr>
					</table>
				</div>
				<div class="container">
					<div class="row">
						...
						<div class="col-4 gap-3">
							...
							<input type="reset" value="취소" class="btn btn-outline-danger btn-lg" onclick="$('#board_title').focus();"/>
						</div>
						<div class="col-3"></div>
					</div>
				</div>
